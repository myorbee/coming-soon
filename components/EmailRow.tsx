  ...
  return (
    ...
    >
      <div className="flex items-center px-4 py-4 gap-4">
        <div className="flex-shrink-0 w-8 h-8 rounded-full bg-orbee-violet flex items-center justify-center text-white font-medium text-sm">
          {senderInitial}
        </div>
        
        <div className="flex-grow min-w-0">
          <div className="flex flex-wrap gap-x-1 items-baseline">
            <span className="font-funnel text-orbee-violet">{orbeePrefix}:</span>
            <span className={cn(
              "truncate",
